...
- GPU ornekleri calistirmak icin uygun donanim ve derleyici gerekir
- Thread sayisini ayarlamak icin: `export OMP_NUM_THREADS=8`
- Performans olcumu icin `omp_get_wtime()` kullanilir

## Lisans

Egitim amacli hazirlanmistir. Serbestce kullanilabilir.
